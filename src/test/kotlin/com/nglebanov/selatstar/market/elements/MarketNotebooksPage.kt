...
//
    //   inner class Sorts {
    //       val поПопулярности = marketElementsFactory.sort("по популярности")
    //       val поЦене = marketElementsFactory.sort("по цене")
    //       val поРейтингу = marketElementsFactory.sort("по рейтингу")
    //       val поОтзывам = marketElementsFactory.sort("по отзывам")
    //       val поРазмеруСкидки = marketElementsFactory.sort("по размеру скидки")
    //       val поНовизне = marketElementsFactory.sort("по новизне")
//
    //   }
